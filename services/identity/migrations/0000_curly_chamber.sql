...
CREATE TABLE "users" (
	...
	"user_role_id" varchar(255) DEFAULT 'user' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "users" ADD CONSTRAINT "users_user_role_id_roles_id_fk" FOREIGN KEY ("user_role_id") REFERENCES "public"."roles"("id") ON DELETE no action ON UPDATE no action;